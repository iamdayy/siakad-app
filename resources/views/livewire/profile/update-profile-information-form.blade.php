...
new class extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->level = Auth::user()->level->title;
    }
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="level" id="level" name="level" type="text" class="block w-full mt-1" required autofocus disabled autocomplete="level" />
